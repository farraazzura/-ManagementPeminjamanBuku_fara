      ...
      <tbody>
        @forelse($transaksis as $key => $transaksi)
          <tr>
            ...
            <td class="actions">
              <a href="{{ route('transaksis.edit', $transaksi->id) }}"><button class="edit" type="button">Edit</button></a>
              ...
              <a href="{{ route('transaksis.print', $transaksi->id) }}"><button class="print" type="button">Cetak</button></a>
            </td>
          </tr>
        @empty
          <tr>
